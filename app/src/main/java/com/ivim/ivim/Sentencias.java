...
public class Sentencias {
    ...
    public static final String TABLA_BASCULAS = "CREATE TABLE basculas(id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, marca TEXT, modelo TEXT, numero_aprobacion TEXT, codigo_marca TEXT, codigo_modelo TEXT, ano_aprobacion TEXT, alcance_minimo TEXT, alcance_maximo)";
