...
public class AdapterMercado extends ArrayAdapter<String> {
    private Activity activity;
    private ArrayList data;
    public Resources res;
    SpinnerModel spinnerModel=null;
    LayoutInflater inflater;
    public AdapterMercado(Mapa activitySpinner, int textViewResourceId, ArrayList objects, Resources resLocal)
    {
